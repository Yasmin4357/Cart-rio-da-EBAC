...
int registro()
{
	char arquivo [40];//Inicio das variáveis/string 
	char cpf[40];
	char nome[40];
	char sobrenome[40];
	char cargo [40];//Final das variáveis/string
	...
	fprintf(file, ",");//Dar espaço entre os arquivos
...
int main ()
{
	...
	printf("Escolha as opções desejada do menu:\n\n");
